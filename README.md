...
A structured documentation is generated by Doxygen. Refer to this [technical page](https://odrans.github.io/S3COM/) for more information. The documentation includes descriptions of all subroutines and modules, with specific examples for usage.
