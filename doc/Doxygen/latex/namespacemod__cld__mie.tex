...
{\footnotesize\ttfamily subroutine, public mod\+\_\+cld\+\_\+mie\+::cld\+\_\+mie\+\_\+load (\begin{DoxyParamCaption}\item[{type(type\+\_\+s3com), intent(in)}]{s3com,  }\item[{type(type\+\_\+cld), intent(out)}]{cld }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily subroutine mod\+\_\+cld\+\_\+mie\+::cld\+\_\+mie\+\_\+read (\begin{DoxyParamCaption}\item[{character(len = 128), intent(in)}]{fn\+\_\+mie,  }\item[{type(type\+\_\+cld\+\_\+mie), intent(out)}]{cld\+\_\+mie }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
