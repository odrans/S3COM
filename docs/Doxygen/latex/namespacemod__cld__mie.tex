...
\begin{DoxyItemize}
\item {\ttfamily cld\+\_\+mie\+\_\+load}\+: general call to subroutines needed to load optical properties for liquid clouds from user-\/defined files
\item {\ttfamily cld\+\_\+mie\+\_\+read}\+: initializes the cld\+\_\+mie structure and loads the Mie scattering data from a net\+CDF file 
\end{DoxyItemize}
